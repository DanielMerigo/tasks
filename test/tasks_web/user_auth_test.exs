defmodule TasksWeb.UserAuthTest do
  use TasksWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Tasks.Users
  alias TasksWeb.UserAuth
  import Tasks.UsersFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TasksWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TasksWeb.Endpoint.subscribe(live_socket_id)
