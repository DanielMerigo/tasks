defmodule TasksWeb.Router do
  ...
  scope "/", TasksWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TasksWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TasksWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TasksWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TasksWeb do
    ...
    live_session :current_user,
      on_mount: [{TasksWeb.UserAuth, :mount_current_user}] do
